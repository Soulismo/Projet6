...
const generateSecondModalContent = () => {
  ...
  submitButton.addEventListener("click", sendNewWork);
...
function picturePreview(e) {
  ...
  const image = document.getElementById("picturePreview");
  ...
  document.getElementById("photo").addEventListener("change", picturePreview);
}
